	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			while (true) //бесконечный цикл
			{
				...
				Snake snake = new Snake(p, 4, Direction.RIGHT,scores); //создание змейки, берет значения: точка p, позиция на оси y, направление движения
				...
				while (true) //бесконечный цикл
				{
					...
					{
						scores = snake.ScorePoint(); //выводится новое значение счета
